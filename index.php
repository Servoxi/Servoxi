...
<style>
   ...
   <div id="loading">
      <div id="loading-center">
         <img src="assets/images/loader-2.gif" alt="loader">
      </div>
   </div>
...
<div class="col-lg-4 col-12 text-center"> <a href="services.php" class="btn btn-primary mt-lg-8">
View All Services
</a>
</div>
</div>
...
<a href="services.php" class="btn btn-outline-primary mt-4">
Learn More
</a>
</div>
</div>
...
<div class="my-4"> <span class="h2">Website</span>
...
<p class="mb-0">Professional web design</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<p class="mb-0">E-commerce solutions</p>
</div>
<div class="d-flex align-items-center">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<p class="mb-0">Search Engine Optimizations</p>
</div>
<div class="d-flex align-items-center">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<div class="card-body py-5 px-4">
<img class="img-fluid" src="assets/images/icon/01.svg" alt="">
<div class="my-4 bg-dark p-3 rounded"> <span class="h2 text-white">Mobile Application Services</span>
<p class="mb-0 text-light">Perfect For Small Businesses</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">User-friendly Desktop</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<p class="mb-0">Teachnology indepemdent</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">Real time update</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<p class="mb-0">in-App support</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">offline Access</p>
</div>
<div class="d-flex align-items-center">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
...
<div class="my-4"> <span class="h2">Devops Services</span>
<p class="mb-0 text-light">Perfect For Long Term Businesses</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">CI/CD pipeline setup</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">IAC implements</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">cloud migration and Deployments</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">Monitoring and Alerting setup</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">docker and kubernates containerization</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">log managment and analysis</p>
</div>
<div class="d-flex align-items-center mb-2">
<div class="me-2"> <i class="las la-check-circle text-primary"></i>
</div>
<p class="mb-0">free 2 weak support</p>
</div>
<div class="d-flex justify-content-between align-items-center mt-5 pt-5 border-top">
<div class="d-flex align-items-start justify-content-center"> <span class="text-muted mt-2"></span>
<span class="price display-4 font-w-6 text-primary mb-0"></span>
...
<div class="col-lg-8">
<div class="mb-5">
<h2 class="mb-0"><span class="font-w-4 d-block">Working with Servoxi web innovations</span> </h2>
</div>
</div>
</div>
...
<script>
      // JavaScript code to hide the preloader after a minimum of 15 seconds
